...
app.get('/*', function (req, res, next) {
    ...
    */
    ...
    res.header("Content-Security-Policy-Report-Only", "default-src https://*; style-src https://*; script-src https://* code.jquery.com/jquery-3.3.1.min.js cdnjs.cloudflare.com; connect-src code.jquery.com; require-sri-for script style; report-uri http://localhost:3000/report;");
